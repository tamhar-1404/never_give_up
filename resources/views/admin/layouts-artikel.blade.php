        ...
        <div id="wrapper" class="enlarged forced">
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div class="user-details">
                        ...
                        <div class="user-info">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="javascript:void(0)" class="dropdown-item"> Profil</a></li>
                                    <li><a href="javascript:void(0)" class="dropdown-item"><span class="badge badge-success float-right">5</span> Pengaturan </a></li>
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="index.html" class="waves-effect"><i class="ti-home"></i><span> Dashboard <span class="badge badge-primary float-right">1</span></span></a>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="pesan-dari-user.html">Pesan Dari User</a></li>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="">
                        <div class="page-header-title" style="height:  70px;">
                        ...
                        <div class="row col-lg-12 justify-content-lg-center"  >
                            <div class="col-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="display: flex; gap: 10px;">
                                        <a href="file:///D:/mini-projek/user_login/nunforest.com/triptip-demo/artikel-sukses.html" class="btn btn-primary">Lihat</a>
                            ...
                            <div class="col-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                                    <div style="display: flex; gap: 10px;">
                                        <a href="tampilan_user/artikel-sukses.html" class="btn btn-primary">Lihat</a>
                                        <a href="#" class="btn btn-danger">hapus </a>
                                    </div>
                                </div>
                                </div>
