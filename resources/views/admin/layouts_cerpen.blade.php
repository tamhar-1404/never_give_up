            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div class="user-details">
                        ...
                        <div class="user-info">
                            <div class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Dzaky</a>
                                <ul class="dropdown-menu">
                                    <li><a href="javascript:void(0)" class="dropdown-item"> Profile</a></li>
                                    <li><a href="javascript:void(0)" class="dropdown-item"><span class="badge badge-success float-right">5</span> Settings </a></li>
                                    <li><a href="javascript:void(0)" class="dropdown-item"> Lock screen</a></li>
                                ...
                                <div class="col-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div style="display: flex; gap: 10px;">
                                            <a href="tampilan_user/cerpen-baik.html" class="btn btn-primary">Lihat</a>
