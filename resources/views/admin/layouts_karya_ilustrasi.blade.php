                ...
                <div class="content">
                    ...
                    <div class="">
                        <div class="page-header-title">
                            <h4 class="page-title">Karya ilustrasi</h4>
                        </div>
                    </div>
                        <div class="row col-lg-12 justify-content-lg-center"  >
                            <div class="col-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <img style="border-radius: 10px;" src="assets/layout.img/ilustrasi.png" class="card-img-top" alt="" srcset="">
                                    <div >
                                    ...
                                    <div style="display: flex; gap: 10px;">
                                        <a href="tampilan_user/ilustrasi-1.html" class="btn btn-primary">Lihat</a>
