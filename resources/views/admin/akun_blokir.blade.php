            ...
            <div class="content-page">
                ...
                <div class="">
                        <div class="page-header-title">
                            <h4 class="page-title">Akun Yang Di Blokir </h4>
                        </div>
                    </div>
                                                    ...
                                                    <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; width: 100%;">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><form action="{{Route('pulihkan', $item->id)}} " method="post" class="col-5">
                                                                @csrf
                                                                <td><button type="submit" class="btn  btn-primary">Pulihkan</button>
                                                                <a href="#">
