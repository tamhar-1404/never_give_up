				...
				<div class="item">
					...
					<div class="col-0">
						...
						<div class="card-body">
							...
							<img style="border-radius: 10px;" src="asset/sukses2.jpg" class="card-img-top" alt="" srcset="">
				...
				<div class="item">
					...
					<div class="col-0">
						...
						<div class="card-body">
							...
							<img style="border-radius: 10px;" src="asset/sukses.jpg" class="card-img-top" alt="" srcset="">
							<ion-icon style="color: pink; font-size: 30px;" name="heart-outline"></ion-icon>
							<p class=""></p>Beberapa Hal Yang Perlu Diterapkan Agar Sukses
					...
					<div class="col-0">
						...
						<div class="card-body">
							...
							<img style="border-radius: 10px;" src="asset/sukses1.jpg" class="card-img-top" alt="" srcset="">
							<ion-icon style="color: pink; font-size: 30px;" name="heart-outline"></ion-icon>
							<p class=""></p>Beberapa Hal Yang Perlu Diterapkan Agar Sukses
