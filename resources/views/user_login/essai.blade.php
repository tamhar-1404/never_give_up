					...
					<div class="col-0">
						...
						<div class="card-body">
							<div style=" display: flex; justify-content:space-between;">
								<img class="card-img" style="border-radius: 100%; width: 30px; height: 30px; " src="data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAoHCBUVFRgVFhUYGBgaGBwYGhgYGhgYGRg
							...
							<img style="border-radius: 10px;  width: 80%;" src="images/ilmiah.PNG" class="card-img-top" alt="" srcset="">
							...
							<div style="width: 100%; display: flex; justify-content: center;  " >
								...
								<div style="width: 100%; display: flex; justify-content: center;  " >
									<div style="width: 100%; display: flex; justify-content: center;  " >
										<a class="contact-form__submit" href="/essai-1" style="margin-right: 20px; margin-bottom: 10px; ">
