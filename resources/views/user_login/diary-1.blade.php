					...
					<div class="container">
						<div class="row">
							<div class="col-sm-9">
									...
									<h1 class="listing-detail__title listing-detail__title-black"> {{$diary->judul}} </h1>	
						...
						<div class="col-lg-8">
							<div class="blog-page__box">
								<div class="listing-detail__content-box listing-detail__content-box-nopadding">
									...
									<img class="single-post__image" src="{{asset('asset/' . $diary->foto)}}" alt="">
									...
									<!-- Contact form module -->
									<form action="/komentar/{{$diary->id}}" method="POST" enctype="multipart/form-data" class="contact-form inner-review" id="leave-review">
										@csrf
											...
											<div class="row">
												<div class="col-7">
													<div class="author-wrapper__content">
														<a class="author-wrapper__image" href=""><img src="{{asset('foto/' . $diary->user->foto)}}" alt=""></a>
														<h3 class="author-wrapper__title">
															<a href="">{{$diary->user->username}}</a>
