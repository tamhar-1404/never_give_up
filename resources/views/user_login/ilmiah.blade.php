				...
				<div class="item">
					...
					<div class="col-0">
						...
						<div class="card-body">
							...
							<img style="border-radius: 10px;  width: 80%;" src="asset/ilmiah.PNG" class="card-img-top" alt="" srcset="">
							...
							<div style="width: 100%; display: flex; justify-content: center;  " >
												<a class="contact-form__submit" href="/ilmiah-detail" style="margin-right: 20px; margin-bottom: 10px; ">
				...
				<div class="item">
					...
					<div class="col-0">
						...
						<div class="card-body">
							...
							<p class="card-text">Jika diberi pertanyaan siapa sih yang ingin sukses? Mungkin semua orang yang diberi pertanyaan tersebut akan mengangkat tangan mereka tinggi-tinggi. Namun, masih banyak orang yang belum mengerti apa itu kesuksesan ...</p>
							<div style="width: 100%; display: flex; justify-content: center;  " >
												<a class="contact-form__submit" href="ilmiah-detail.html" style="margin-right: 20px; margin-bottom: 10px; ">
													<i class="fa fa-caret-right" aria-hidden="true"></i>
													Baca
												</a>
											</div>
