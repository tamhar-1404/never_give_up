...
<body>
	...
	<div id="container">
				...
				<div class="row">
					<div class="col-lg-8 col-md-8">
						...
						<form class="contact-form" id="contact-form">
							...
							<textarea class="contact-form__textarea" name="comment" id="comment" placeholder="Alasan"></textarea>
							<input class="contact-form__submit" type="submit" name="submit-contact" id="submit_contact" value="Kirim Pesan" />
						</form>
						...
						<div class="contact-post">
							...
							<div class="contact-post__content">
								...
								<p class="contact-post__description">
									Perum Permata Regency 1 Blok 10/28, Perun Gpa, Ngijo, Kec. Karang Ploso, Kabupaten Malang, Jawa Timur 65152								</p>
							</div>
						</div>
		...
		<!-- map block
			================================================== -->
								<!-- <div id="mapSingle" data-latitude="-7.899957097157664" data-longitude="112.60688599674866" data-map-icon="la la-home"></div> -->
								<!-- <div class="contact-map"><div id="mapSingle" data-latitude="-7.899957097157664" data-longitude="112.60688599674866" data-map-icon="la la-map-marker"></div></div> -->

		<!-- End map block -->

		<!-- map block
			================================================== -->
			<div class="contact-map"><div id="mapSingle" data-latitude="51.5344894" data-longitude="-0.1370057" data-map-icon="la la-map-marker"></div></div>
			<!-- End map block -->
