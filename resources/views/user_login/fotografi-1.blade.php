			...
			<div class="listing-detail__gal">
				<div class="listing-detail__title-box">
					<div class="container">
						<div class="row">
							<div class="col-sm-9">
							<h1 class="listing-detail__title listing-detail__title-black"> {{$photography->judul}} </h1>	
								...
								<div class="listing-detail__content-box listing-detail__content-box-nopadding">
									...
									<div class="listing-detail__galleria">
										<div class="item-image">
											<img src="{{asset('asset/' . $photography->foto)}}" alt="">
										</div>
									...
									<!-- Contact form module -->
									<form action="/komentar/{{$photography->id}}" method="POST" enctype="multipart/form-data" class="contact-form inner-review" id="leave-review">
										@csrf
								...
								<div class="sidebar__widget sidebar__widget-listing-details">
									...
									<ul class="sidebar__listing-list">
										<li>
											...
											{{$photography->user->askot}}
										</li>
										<li>
											<i class="la la-mobile-phone"></i>
											0{{$photography->user->notlp}}
										</li>
										<li>
											<i class="la la-link"></i>
											{{$photography->user->email}}
										</li>
										<!-- <li>
											...
											<div class="row">
												<div class="col-7">
													<div class="author-wrapper__content">
														<a class="author-wrapper__image" href=""><img src="{{asset('foto/' . $photography->user->foto)}}" alt=""></a>
														<h3 class="author-wrapper__title">
															<a href="">{{$photography->user->username}}</a>
															<span class="author-wrapper__location">
															{{$photography->user->medsos}}
															</span>
														</h3>
													</div>
												</div>
