				...
				<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							...
							<a href="add-listing.html" class="add-list-btn btn-default"><i class="fa fa-plus" aria-hidden="true"></i> posting</a>
							
						</div><a href="user-page.html" class="add-list-btn btn-default"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16">
