					...
					<div class="col-0">
						...
						<div class="card-body">
							...
							<div style="display: flex; justify-content: center;">
								<img style="border-radius: 10px; width: 50%;" src="asset/sampul-makalah.webp" class="card-img-top" alt="" srcset="">
							</div>
							<ion-icon style="color: pink; font-size: 30px;" name="heart-outline"></ion-icon>
							<p class="card-text-judul">nilai nilai pancasila</p>
							
							<p class="card-text">nama pembuat : </p>
							<p class="card-text">universitas / sekolah : </p>
							<p class="card-text">tanggal posting : </p>
				...
				<div class="item">
					...
					<div class="col-0">
						...
						<div class="card-body">
							...
							<div style="display: flex; justify-content: center;">
								<img style="border-radius: 10px; width: 50%;" src="asset/sampul-makalah.webp" class="card-img-top" alt="" srcset="">
							</div>							<ion-icon style="color: pink; font-size: 30px;" name="heart-outline"></ion-icon>
							<p class="card-text-judul">nilai nilai pancasila</p>
			...
			<br>
					<div style="display: flex; justify-content: center;">
						<nav aria-label="Page navigation example" >
							<ul class="pagination">
								<li class="page-item">
									<a class="page-link" style="border-radius: 10px;" href="#" aria-label="Previous">
