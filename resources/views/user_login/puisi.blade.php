				...
				<div class="item">
					...
					<div class="col-0">
						...
						<div class="card-body">
							...
							<img style="border-radius: 10px; max-width: 750px; max-height: 200px;" src="asset/ibup.jpg" class="card-img-top" alt="" srcset="">
							<ion-icon style="color: pink; font-size: 30px;" name="heart-outline"></ion-icon>
							<p class="card-text-judul">Apa Kabar Ibu Pertiwi </p>
							
							<p class="card-text"></p>
							<div style="width: 100%; display: flex; justify-content: center;  " >
								<a class="contact-form__submit" href="/puisi-pertiwi" style="margin-right: 20px; margin-bottom: 10px; ">
				...
				<div class="item">
					...
					<div class="col-0">
						...
						<div class="card-body">
							...
							<img style="border-radius: 10px;" src="images/sukses.jpg" class="card-img-top" alt="" srcset="">
							<ion-icon style="color: pink; font-size: 30px;" name="heart-outline"></ion-icon>
							<p class="card-text-judul">Beberapa Hal Yang Perlu Diterapkan Agar Sukses</p>
