...
<!-- End Header -->
		...
		<!-- <section class="add-listing">
			...
			<div class="listing-detail_buttons listing-detail_buttons-icons ">
			<div style="margin-bottom: 2%; display: flex; justify-content: space-between " >
			<h1 >													
				Artikel	</h1>
				<form class="search-form"  >
					<div class="search-form_input-holders" class="listing-detailbuttons listing-detail_buttons-icons" style="width: 100% ;">
