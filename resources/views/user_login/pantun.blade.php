				...
				<div class="item">
					...
					<div class="col-0">
						...
						<div class="card-body">
							...
							<img style="border-radius: 10px; max-width: 750px; max-height: 200px;" src="" class="card-img-top" alt="" srcset="">
							<ion-icon style="color: pink; font-size: 30px;" name="heart-outline"></ion-icon>
							<p class="card-text-judul">Pantun Jenaka</p>
							
							<p class="card-text">Berenang jauh para ikan<br>
								Mereka bebas hatinya senang<br>
								Badan kurus kurang makan<br>
								Kalau ditiup goyang-goyang</p><br>
								<div style="width: 100%; display: flex; justify-content: center;  " >
								<a class="contact-form__submit" href="/pantun-1" style="margin-right: 20px; margin-bottom: 10px; ">
					...
					<div class="col-0">
						...
						<div class="card-body">
							<div style=" display: flex; justify-content:space-between;">
							   ...
							   <div >
								<ion-icon style="border-radius: 10px; max-width: 750px; max-height: 200px;" name="ellipsis-vertical-outline"></ion-icon>
							   </div>
							</div>
							<img style="border-radius: 10px; max-width: 750px; max-height: 200px;" src="" class="card-img-top" alt="" srcset="">
							<ion-icon style="color: pink; font-size: 30px;" name="heart-outline"></ion-icon>
							...
							<p class="card-text">Berenang jauh para ikan<br>
								...
								Kalau ditiup goyang-goyang</p><br>
								<div style="width: 100%; display: flex; justify-content: center;" >
								<a class="contact-form__submit" href="pantunn.html" style="margin-right: 20px; margin-bottom: 10px;  ">
									<i class="fa fa-caret-right" aria-hidden="true"></i>
									Baca
								</a>
							</div>
